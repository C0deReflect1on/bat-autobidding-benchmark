...
from example_notebooks.experiments.baselines.profiles import build_config, list_profiles
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a canonical baseline family experiment.")
    parser.add_argument("--run-name", choices=list_profiles(), default="linear_default")
