...
from example_notebooks.experiments.exp_configs import ExperimentResultsLinearConfig
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the simple linear bidder experiment on the permanent subsample.")
    parser.add_argument("--n-trials", type=int, default=None)
    args = parser.parse_args()

    require_subsample_ready()
    config = ExperimentResultsLinearConfig()
